...
<div class="sticky top-[25vh]  flex flex-col items-center space-y-8 pt-5">
    ...
    <div class="relative w-full px-2 border" data-te-dropdown-ref>
        <button
        class="flex items-center text-center w-full text-xl text-white hover:text-orange-600 transform duration-200" type="button" id="dropdownMenuLargeButton" data-te-dropdown-toggle-ref aria-expanded="false" data-te-ripple-init data-te-ripple-color="light"> Marcas </button>
        <ul class="absolute z-[1000] left-0 m-0 hidden w-[200px] min-w-max list-none overflow-hidden bg-white [&[data-te-dropdown-show]]:block" aria-labelledby="dropdownMenuLargeButton"data-te-dropdown-menu-ref>
            <li>
                <a class="block w-full bg-transparent" href="#" data-te-dropdown-item-ref>Marca 1</a>
            </li>
            <li>
                <a class="block w-full  bg-transparent " href="#" data-te-dropdown-item-ref >Marca 2</a>
            </li>
            <li>
                <a class="block w-full  bg-transparent" href="#" data-te-dropdown-item-ref>Marca 3</a >
            </li>
        </ul>
    </div>
</div>