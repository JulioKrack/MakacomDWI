...
<% 
    ...
    ArrayList<Proveedor> proveedores = usuDAO.ListarProveedor();
    MarcasDAO marcasDAO = new MarcasDAO();
    ArrayList<Marca> marcas = marcasDAO.Listar();
%>
                    ...
                    <div class="relative w-full">
                        <table class="w-full text-center max-sm:text-xs sm:text-base " id="myTable">
                            ...
                            <%  if (proveedores.isEmpty()) {  %>
                             ...
                             <% } else {
                                    for (Proveedor clie : proveedores) { 
                                        String marcaNombre = "";
                                        for (Marca marca : marcas) {
                                            if (marca.getId() == clie.getMarca()) {
                             ...
                             %>
                                    <tr class="border-b hover:bg-black transform duration-200" >
                                        ...
                                        <td class="p-2 truncate max-w-[140px]"><%= marcaNombre %></td>
                                        ...
                                        <td class="flex justify-center gap-2 p-2">
                                            ...
                                            <% if(proveedores.size() > 0 && clie.getId() != uSesion.getId()) { %>
                ...
                <form action="../../ctrlProveedor" method="POST" class="text-white  w-[500px] text-xl flex flex-col gap-3" autocomplete="off">
                    <div class="flex flex-col space-y-5 p-6">
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            <select id="marcaPro" name="marcaPro" required class="outline-none border p-2 bg-neutral-950">
                                <% for (Marca marca : marcas) { %>
